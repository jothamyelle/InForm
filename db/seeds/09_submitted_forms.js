  ...
  return knex('submitted_forms').del()
    .then(function () {
      return Promise.all([
        ...
        knex('submitted_forms').insert({form_template_id: 1, user_id: 1, job_id: 1, date_created: new Date('Tue Sep 25 2018 13:57:51 GMT-0700 (PDT)').toISOString(), date_updated: new Date('Tue Sep 25 2018 13:57:51 GMT-0700 (PDT)').toISOString() }),
        knex('submitted_forms').insert({form_template_id: 2, user_id: 1, job_id: 1, date_created: new Date('Tue Sep 25 2018 13:57:51 GMT-0700 (PDT)').toISOString(), date_updated: new Date('Tue Sep 25 2018 13:57:51 GMT-0700 (PDT)').toISOString() }),
